...
CREATE TABLE `tg_study_course` (
  ...
  `class_room_name` varchar(128) DEFAULT NULL,
  `teacher_id` varchar(64) DEFAULT NULL,
  `teacher_name` varchar(64) DEFAULT NULL,
  `status` varchar(16) DEFAULT NULL,
  `description` varchar(255) DEFAULT NULL,
...
insert  into `tg_study_course`(`id`,`week_info`,`course_time`,`class_id`,`class_name`,`class_room_id`,`class_room_name`,`teacher_id`,`teacher_name`,`status`,`description`,`create_time`,`update_time`,`classroom_id`,`classroom_name`) values ('U154234929855961102','星期六','18:00-20:30','U154234918128406080','专业晋级班',NULL,NULL,'U154234886659443576','老师诸葛亮','NORMAL','一周一课','2018-11-16 14:21:39',NULL,'U154234906292247197','灵秀二楼东1间'),('U154234931077499355','星期天','18:00-20:30','U154234925768951822','高级进修班',NULL,NULL,'U154234889360768899','老师姜维','NORMAL','一周一课','2018-11-16 14:21:51',NULL,'U154234906292247197','灵秀二楼东1间');
...
insert  into `tg_study_student`(`id`,`name`,`sex`,`birthday`,`school_name`,`level`,`parent_phone`,`parent_name`,`parent_type`,`status`,`total_course`,`remain_course`,`create_time`,`update_time`) values ('U154234936651434629','学生小小白',1,'2010-01-08','东港小学',19,'18861520010','家长大大白(父亲)',1,'NORMAL',20,20,'2018-11-16 14:22:47',NULL),('U154234942136853130','学生小小红',2,'2010-11-19','东港小学',19,'18861530020','家长大大红(母亲)',2,'NORMAL',20,20,'2018-11-16 14:23:41',NULL);
...
insert  into `tg_study_student_course_rel`(`id`,`course_id`,`course_week_info`,`course_time`,`class_id`,`class_name`,`classroom_id`,`classroom_name`,`teacher_id`,`teacher_name`,`student_id`,`student_name`,`status`,`create_time`,`update_time`) values ('U154234943207197931','U154234929855961102','星期六','18:00-20:30','U154234918128406080','专业晋级班','U154234906292247197','灵秀二楼东1间','U154234886659443576','老师诸葛亮','U154234942136853130','学生小小红','NORMAL','2018-11-16 14:23:52',NULL);
