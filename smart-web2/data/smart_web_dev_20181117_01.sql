...
insert  into `tg_study_class`(`id`,`name`,`teacher_id`,`teacher_name`,`status`,`level`,`create_time`,`update_time`,`description`) values ('U154234918128406080','专业晋级班','U154234886659443576','老师诸葛亮','NORMAL','senior','2018-11-16 14:19:41',NULL,'专业9段助你围棋突破瓶颈'),('U154234925768951822','高级进修班','U154234889360768899','老师姜维','NORMAL','senior','2018-11-16 14:20:58',NULL,'著名围棋教师，专业8段授课，席位有限');
...
insert  into `tg_study_classroom`(`id`,`study_school_id`,`study_school_name`,`name`,`status`,`description`,`create_time`,`update_time`) values ('U154234906292247197','U154234867270182157','灵秀围棋协会','灵秀二楼东1间','NORMAL','灵秀街围棋协会二楼东北第一间','2018-11-16 14:17:43',NULL);
...
CREATE TABLE `tg_study_course` (
  `id` varchar(64) NOT NULL,
  `name` varchar(64) DEFAULT NULL,
  `week_info` varchar(16) DEFAULT NULL,
  `course_index` tinyint(1) DEFAULT NULL,
...
insert  into `tg_study_course`(`id`,`name`,`week_info`,`course_index`,`course_time`,`classroom_id`,`classroom_name`,`teacher_id`,`teacher_name`,`status`,`description`,`create_time`,`update_time`,`class_id`,`class_name`) values ('U154234929855961102','班级1','星期六',NULL,'18:00-20:30','U154234906292247197','灵秀二楼东1间','U154234886659443576','老师诸葛亮','NORMAL','一周一课','2018-11-16 14:21:39',NULL,NULL,NULL),('U154234931077499355','班级2','星期天',NULL,'18:00-20:30','U154234906292247197','灵秀二楼东1间','U154234889360768899','老师姜维','NORMAL','一周一课','2018-11-16 14:21:51',NULL,NULL,NULL);
...
CREATE TABLE `tg_study_course_record` (
  ...
  `student_personal_leavel` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `tg_study_course_record` */

insert  into `tg_study_course_record`(`id`,`course_id`,`course_date`,`course_time`,`class_id`,`class_name`,`classroom_id`,`classroom_name`,`teacher_id`,`teacher_name`,`student_quantity_plan`,`student_quantity_actual`,`student_personal_leave`,`student_play_truant`,`student_other_absent`,`status`,`create_time`,`update_time`,`description`,`student_personal_leavel`) values ('U154237676310759492','U154234929855961102','2018-11-24','18:00-20:30','U154234918128406080','专业晋级班','U154234906292247197','灵秀二楼东1间','U154234886659443576','老师诸葛亮',1,0,NULL,0,0,'NORMAL','2018-11-16 21:59:23',NULL,NULL,0),('U154237676312433619','U154234931077499355','2018-11-25','18:00-20:30','U154234925768951822','高级进修班','U154234906292247197','灵秀二楼东1间','U154234889360768899','老师姜维',0,0,NULL,0,0,'NORMAL','2018-11-16 21:59:23',NULL,NULL,0);
...
CREATE TABLE `tg_study_course_student_record` (
  `id` varchar(64) NOT NULL,
  `course_rec_id` varchar(64) DEFAULT NULL,
...
insert  into `tg_study_course_student_record`(`id`,`course_rec_id`,`student_id`,`student_name`,`status`,`create_time`,`update_time`,`description`) values ('U154242405992378251','U154237676310759492','U154234942136853130','学生小小红','NORMAL','2018-11-17 11:07:26',NULL,NULL);
...
insert  into `tg_study_school`(`id`,`name`,`address`,`create_time`,`status`) values ('U154234867270182157','灵秀围棋协会','东港灵秀街','2018-11-16 14:11:13','NORMAL');
...
insert  into `tg_study_student`(`id`,`name`,`age`,`sex`,`birthday`,`school_name`,`level`,`parent_phone`,`parent_name`,`parent_type`,`status`,`total_course`,`remain_course`,`create_time`,`update_time`) values ('U154234936651434629','学生小小白',8,1,'2010-01-08','东港小学',19,'18861520010','家长大大白(父亲)',1,'NORMAL',20,20,'2018-11-16 14:22:47',NULL),('U154234942136853130','学生小小红',8,2,'2010-11-19','东港小学',19,'18861530020','家长大大红(母亲)',2,'NORMAL',20,20,'2018-11-16 14:23:41',NULL);
...
insert  into `tg_study_student_class_rel`(`id`,`class_id`,`class_name`,`teacher_id`,`teacher_name`,`student_id`,`student_name`,`status`,`create_time`,`update_time`) values ('U154234943203515354','U154234918128406080','专业晋级班','U154234886659443576','老师诸葛亮','U154234942136853130','学生小小红','NORMAL','2018-11-16 14:23:52',NULL),('U154234944378467059','U154234925768951822','高级进修班','U154234889360768899','老师姜维','U154234942136853130','学生小小红','NORMAL','2018-11-16 14:24:04',NULL);
...
CREATE TABLE `tg_study_student_course_rel` (
  ...
  `classroom_name` varchar(64) DEFAULT NULL,
  `course_time` varchar(32) DEFAULT NULL,
  `course_week_info` varchar(32) DEFAULT NULL,
  `teacher_id` varchar(64) DEFAULT NULL,
  `teacher_name` varchar(64) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
insert  into `tg_study_student_course_rel`(`id`,`course_id`,`student_id`,`student_name`,`status`,`create_time`,`update_time`,`class_id`,`class_name`,`classroom_id`,`classroom_name`,`course_time`,`course_week_info`,`teacher_id`,`teacher_name`) values ('U154234943207197931','U154234929855961102','U154234942136853130','学生小小红','NORMAL','2018-11-16 14:23:52',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
insert  into `tg_study_teacher`(`id`,`name`,`phone`,`level`,`status`,`create_time`,`update_time`) values ('U154234886659443576','老师诸葛亮','18861510001','专业9段','NORMAL','2018-11-16 14:14:27',NULL),('U154234889360768899','老师姜维','18861530002','专业8段','NORMAL','2018-11-16 14:14:54',NULL);
