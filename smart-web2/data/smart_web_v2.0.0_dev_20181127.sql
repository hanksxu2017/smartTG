...
insert  into `tg_study_course`(`id`,`name`,`week_info`,`course_time_index`,`course_time`,`school_id`,`school_name`,`classroom_id`,`classroom_name`,`teacher_id`,`teacher_name`,`status`,`description`,`create_time`,`update_time`) values ('U154287287751332438','周宏斌星期二5',2,5,'18:30-20:00','U154278937639961731','灵秀','U154278944159689965','灵秀一','U154278954605976028','周宏斌','NORMAL','','2018-11-22 15:47:58',NULL),('U154287288842867264','周宏斌星期三5',3,5,'18:30-20:00','U154278937639961731','灵秀','U154278944159689965','灵秀一','U154278954605976028','周宏斌','NORMAL','','2018-11-22 15:48:08',NULL),('U154287292108462387','周宏斌星期六3',6,3,'13:30-15:00','U154278937639961731','灵秀','U154278944159689965','灵秀一','U154278954605976028','周宏斌','NORMAL','','2018-11-22 15:48:41',NULL);
...
CREATE TABLE `tg_study_renew_record` (
  ...
  `student_id` bigint(64) DEFAULT NULL,
  `student_name` varchar(64) DEFAULT NULL,
  `amount` bigint(16) DEFAULT NULL COMMENT '额度,单位分',
...
insert  into `tg_study_renew_record`(`id`,`student_id`,`student_name`,`amount`,`course_count`,`description`,`create_time`,`operator_id`,`operator_full_name`) values (24094254999819,22384029931917,'测试学生02',1000,20,'续费，增加课时','2018-11-27 15:22:29','U141770099155103287','超级管理员'),(24115494258965,22384029931917,'测试学生02',1000,20,'继续增加课时','2018-11-27 15:22:51','U141770099155103287',NULL);
...
insert  into `tg_study_system_message`(`id`,`message_type`,`message_content`,`level`,`is_process`,`create_time`,`process_time`,`process_desc`) values ('1','STUDENT_REMAIN_COURSE_NOTE','学生小蓝仅剩余 3课时!   ',20,'NO','2018-11-21 09:08:22','2018-11-20 22:18:22',NULL);
