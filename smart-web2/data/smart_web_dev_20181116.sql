...
CREATE TABLE `tg_study_course_record` (
  ...
  `course_start_time` varchar(32) DEFAULT NULL,
  `course_end_time` varchar(32) DEFAULT NULL,
  `class_id` varchar(64) DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `course_id` (`course_id`,`course_start_time`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
