...
insert  into `tg_study_system_message`(`id`,`message_type`,`message_content`,`level`,`is_process`,`create_time`,`process_time`,`process_desc`) values ('1','STUDENT_REMAIN_COURSE_NOTE','学生小蓝仅剩余 3课时!   ',0,'NO',NULL,'2018-11-20 22:18:22',NULL);
